...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            if (!isNewsletter) {
                if ((_h = (_g = message === null || message === void 0 ? void 0 : message.viewOnceMessage) === null || _g === void 0 ? void 0 : _g.message) === null || _h === void 0 ? void 0 : _h.interactiveMessage) {
                    if (!stanza.content || !Array.isArray(stanza.content)) {
                        stanza.content = [];
                    }
                    stanza.content.push({
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
                ...
                await relayMessage(jid, fullMsg.message, { messageId: fullMsg.key.id, useCachedGroupMetadata: options.useCachedGroupMetadata, additionalAttributes, additionalNodes: options.additionalNodes, statusJidList: options.statusJidList });
